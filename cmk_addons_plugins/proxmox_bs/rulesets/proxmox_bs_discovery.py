...
def _parameter_form_proxmox_bs_discovery() -> Dictionary:
    return Dictionary(
...
rule_spec_pbs_snapshot_age_discovery = DiscoveryParameters(
    title=Title("Proxmox Backup Server"),
    topic=Topic.STORAGE,
    name="proxmox_bs_discovery",
    parameter_form=_parameter_form_proxmox_bs_discovery,
    help_text=Help("Used to limit the Datastores monitored.")
)
